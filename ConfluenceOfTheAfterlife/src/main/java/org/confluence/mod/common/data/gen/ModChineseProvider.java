...
public class ModChineseProvider extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        //region blocks
        add(ModOreBlocks.SANCTIFICATION_COAL_ORE.get(), "圣化煤矿石");
        add(ModOreBlocks.CORRUPTION_COAL_ORE.get(), "腐化煤矿石");
        add(ModOreBlocks.FLESHIFICATION_COAL_ORE.get(), "血化煤矿石");
        add(ModOreBlocks.TIN_ORE.get(), "锡矿石");
        add(ModOreBlocks.SANCTIFICATION_TIN_ORE.get(), "圣化锡矿石");
        add(ModOreBlocks.CORRUPTION_TIN_ORE.get(), "腐化锡矿石");
        add(ModOreBlocks.FLESHIFICATION_TIN_ORE.get(), "血化锡矿石");
        add(ModOreBlocks.DEEPSLATE_TIN_ORE.get(), "深层锡矿石");
        add(ModOreBlocks.RAW_TIN_BLOCK.get(), "粗锡块");
        add(ModOreBlocks.TIN_BLOCK.get(), "锡块");
        add(ModOreBlocks.SANCTIFICATION_COPPER_ORE.get(), "圣化铜矿石");
        add(ModOreBlocks.CORRUPTION_COPPER_ORE.get(), "腐化铜矿石");
        add(ModOreBlocks.FLESHIFICATION_COPPER_ORE.get(), "血化铜矿石");
        add(ModOreBlocks.SANCTIFICATION_IRON_ORE.get(), "圣化铁矿石");
        add(ModOreBlocks.CORRUPTION_IRON_ORE.get(), "腐化铁矿石");
        add(ModOreBlocks.FLESHIFICATION_IRON_ORE.get(), "血化铁矿石");
        add(ModOreBlocks.LEAD_ORE.get(), "铅矿石");
        add(ModOreBlocks.SANCTIFICATION_LEAD_ORE.get(), "圣化铅矿石");
        add(ModOreBlocks.CORRUPTION_LEAD_ORE.get(), "腐化铅矿石");
        add(ModOreBlocks.FLESHIFICATION_LEAD_ORE.get(), "血化铅矿石");
        add(ModOreBlocks.DEEPSLATE_LEAD_ORE.get(), "深层铅矿石");
        add(ModOreBlocks.RAW_LEAD_BLOCK.get(), "粗铅块");
        add(ModOreBlocks.LEAD_BLOCK.get(), "铅块");
        add(ModOreBlocks.SILVER_ORE.get(), "银矿石");
        add(ModOreBlocks.SANCTIFICATION_SILVER_ORE.get(), "圣化银矿石");
        add(ModOreBlocks.CORRUPTION_SILVER_ORE.get(), "腐化银矿石");
        add(ModOreBlocks.FLESHIFICATION_SILVER_ORE.get(), "血化银矿石");
        add(ModOreBlocks.DEEPSLATE_SILVER_ORE.get(), "深层银矿石");
        add(ModOreBlocks.RAW_SILVER_BLOCK.get(), "粗银块");
        add(ModOreBlocks.SILVER_BLOCK.get(), "银块");
        add(ModOreBlocks.TUNGSTEN_ORE.get(), "钨矿石");
        add(ModOreBlocks.SANCTIFICATION_TUNGSTEN_ORE.get(), "圣化钨矿石");
        add(ModOreBlocks.CORRUPTION_TUNGSTEN_ORE.get(), "腐化钨矿石");
        add(ModOreBlocks.FLESHIFICATION_TUNGSTEN_ORE.get(), "血化钨矿石");
        add(ModOreBlocks.DEEPSLATE_TUNGSTEN_ORE.get(), "深层钨矿石");
        add(ModOreBlocks.RAW_TUNGSTEN_BLOCK.get(), "粗钨块");
        add(ModOreBlocks.TUNGSTEN_BLOCK.get(), "钨块");
        add(ModOreBlocks.SANCTIFICATION_GOLD_ORE.get(), "圣化金矿石");
        add(ModOreBlocks.CORRUPTION_GOLD_ORE.get(), "腐化金矿石");
        add(ModOreBlocks.FLESHIFICATION_GOLD_ORE.get(), "血化金矿石");
        add(ModOreBlocks.PLATINUM_ORE.get(), "铂金矿石");
        add(ModOreBlocks.SANCTIFICATION_PLATINUM_ORE.get(), "圣化铂金矿石");
        add(ModOreBlocks.CORRUPTION_PLATINUM_ORE.get(), "腐化铂金矿石");
        add(ModOreBlocks.FLESHIFICATION_PLATINUM_ORE.get(), "血化铂金矿石");
        add(ModOreBlocks.DEEPSLATE_PLATINUM_ORE.get(), "深层铂金矿石");
        add(ModOreBlocks.RAW_PLATINUM_BLOCK.get(), "粗铂金块");
        add(ModOreBlocks.PLATINUM_BLOCK.get(), "铂金块");
        add(ModOreBlocks.RUBY_ORE.get(), "红玉矿石");
        add(ModOreBlocks.SANCTIFICATION_RUBY_ORE.get(), "圣化红玉矿石");
        add(ModOreBlocks.CORRUPTION_RUBY_ORE.get(), "腐化红玉矿石");
        add(ModOreBlocks.FLESHIFICATION_RUBY_ORE.get(), "血化红玉矿石");
        add(ModOreBlocks.DEEPSLATE_RUBY_ORE.get(), "深层红玉矿石");
        add(ModOreBlocks.TOPAZ_ORE.get(), "黄玉矿石");
        add(ModOreBlocks.SANCTIFICATION_TOPAZ_ORE.get(), "圣化黄玉矿石");
        add(ModOreBlocks.CORRUPTION_TOPAZ_ORE.get(), "腐化黄玉矿石");
        add(ModOreBlocks.FLESHIFICATION_TOPAZ_ORE.get(), "血化黄玉矿石");
        add(ModOreBlocks.DEEPSLATE_TOPAZ_ORE.get(), "深层黄玉矿石");
        add(ModOreBlocks.AMBER_ORE.get(), "琥珀矿石");
        add(ModOreBlocks.SANCTIFICATION_AMBER_ORE.get(), "圣化琥珀矿石");
...
//        add(ModOreBlocks.DEEPSLATE_TR_EMERALD_ORE.get(), "深层翡翠矿石");
        ...
        add(ModOreBlocks.FLESHIFICATION_TR_AMETHYST_ORE.get(), "血化异域紫晶矿石");
        add(ModOreBlocks.DEEPSLATE_TR_AMETHYST_ORE.get(), "深层异域紫晶矿石");
        add(ModOreBlocks.SAPPHIRE_ORE.get(), "蓝玉矿石");
        add(ModOreBlocks.SANCTIFICATION_SAPPHIRE_ORE.get(), "圣化蓝玉矿石");
        add(ModOreBlocks.CORRUPTION_SAPPHIRE_ORE.get(), "腐化蓝玉矿石");
        add(ModOreBlocks.FLESHIFICATION_SAPPHIRE_ORE.get(), "血化蓝玉矿石");
        add(ModOreBlocks.DEEPSLATE_SAPPHIRE_ORE.get(), "深层蓝玉矿石");
        add(ModOreBlocks.SANCTIFICATION_EMERALD_ORE.get(), "珍珠石绿宝石矿石");
        add(ModOreBlocks.CORRUPTION_EMERALD_ORE.get(), "腐化绿宝石矿石");
        add(ModOreBlocks.FLESHIFICATION_EMERALD_ORE.get(), "血化绿宝石矿石");
        add(ModOreBlocks.SANCTIFICATION_DIAMOND_ORE.get(), "圣化钻石矿石");
        add(ModOreBlocks.CORRUPTION_DIAMOND_ORE.get(), "腐化钻石矿石");
        add(ModOreBlocks.FLESHIFICATION_DIAMOND_ORE.get(), "血化钻石矿石");
        add(ModOreBlocks.SANCTIFICATION_LAPIS_ORE.get(), "珍珠石青金石矿石");
        add(ModOreBlocks.CORRUPTION_LAPIS_ORE.get(), "腐化青金石矿石");
        add(ModOreBlocks.FLESHIFICATION_LAPIS_ORE.get(), "血化青金石矿石");
        add(ModOreBlocks.METEORITE_ORE.get(), "陨石矿石");
        add(ModOreBlocks.RAW_METEORITE_BLOCK.get(), "粗陨石块");
        add(ModOreBlocks.METEORITE_BLOCK.get(), "陨石块");
        add(ModOreBlocks.STURDY_FOSSIL_BLOCK.get(), "坚固化石块");
        add(ModOreBlocks.EBONY_ORE.get(), "魔矿石");
        add(ModOreBlocks.SANCTIFICATION_EBONY_ORE.get(), "圣化魔矿石");
        add(ModOreBlocks.CORRUPTION_EBONY_ORE.get(), "腐化魔矿石");
        add(ModOreBlocks.FLESHIFICATION_EBONY_ORE.get(), "血化魔矿石");
        add(ModOreBlocks.DEEPSLATE_EBONY_ORE.get(), "深层魔矿石");
        add(ModOreBlocks.EBONY_BLOCK.get(), "魔矿块");
        add(ModOreBlocks.RAW_EBONY_BLOCK.get(), "魔原矿块");
        add(ModOreBlocks.TR_CRIMSON_ORE.get(), "猩红矿石");
        add(ModOreBlocks.SANCTIFICATION_TR_CRIMSON_ORE.get(), "圣化猩红矿石");
        add(ModOreBlocks.CORRUPTION_TR_CRIMSON_ORE.get(), "腐化猩红矿石");
        add(ModOreBlocks.FLESHIFICATION_TR_CRIMSON_ORE.get(), "血化猩红矿石");
        add(ModOreBlocks.DEEPSLATE_TR_CRIMSON_ORE.get(), "深层猩红矿石");
        add(ModOreBlocks.TR_CRIMSON_BLOCK.get(), "猩红矿块");
        add(ModOreBlocks.RAW_TR_CRIMSON_BLOCK.get(), "猩红原矿块");
        add(ModOreBlocks.HELLSTONE.get(), "下界狱石");
        add(ModOreBlocks.ASH_HELLSTONE.get(), "灰烬狱石");
...
//        add(ModOreBlocks.DEEPSLATE_TITANIUM_ORE.get(), "深层钛金矿");
        ...
        add(ModOreBlocks.RAW_CHLOROPHYTE_BLOCK.get(), "叶绿粗矿块");
        add(ModOreBlocks.LUMINITE_BLOCK.get(), "夜明块");
        add(ModOreBlocks.RAW_LUMINITE_BLOCK.get(), "夜明粗矿块");
...
//        add(Swords.TERRAGRIM.get(),"泰拉魔刃");
        ...
        add(ModArmors.CACTUS_HELMET.get(), "仙人掌头盔");
        add(ModArmors.CACTUS_LEGGINGS.get(), "仙人掌护腿");
        add(ModArmors.CACTUS_BOOTS.get(), "仙人掌靴子");
        add(ModArmors.PLANK_CHESTPLATE.get(), "木制胸甲");
...
//        add(ModArmors.RAINCOAT.get(), "雨衣");
        ...
        add(ModArmors.INSULATED_SHOES.get(), "保温鞋");
        add(ModArmors.PINK_SNOW_CAPS.get(), "粉色防雪帽");
        add(ModArmors.PINK_SNOW_SUITS.get(), "粉色防雪衣");
        add(ModArmors.PINK_INSULATED_PANTS.get(), "粉色保温裤");
        add(ModArmors.PINK_INSULATED_SHOES.get(), "粉色保温鞋");
        add(ModArmors.COPPER_HELMET.get(), "铜头盔");
        add(ModArmors.COPPER_CHESTPLATE.get(), "铜胸甲");
        add(ModArmors.COPPER_LEGGINGS.get(), "铜护腿");
        add(ModArmors.COPPER_BOOTS.get(), "铜靴子");
        add(ModArmors.TIN_HELMET.get(), "锡头盔");
        add(ModArmors.TIN_CHESTPLATE.get(), "锡胸甲");
        add(ModArmors.TIN_LEGGINGS.get(), "锡护腿");
        add(ModArmors.TIN_BOOTS.get(), "锡靴子");
        add(ModArmors.LEAD_HELMET.get(), "铅头盔");
        add(ModArmors.LEAD_CHESTPLATE.get(), "铅胸甲");
        add(ModArmors.LEAD_LEGGINGS.get(), "铅护腿");
        add(ModArmors.LEAD_BOOTS.get(), "铅靴子");
        add(ModArmors.SILVER_HELMET.get(), "银头盔");
        add(ModArmors.SILVER_CHESTPLATE.get(), "银胸甲");
        add(ModArmors.SILVER_LEGGINGS.get(), "银护腿");
        add(ModArmors.SILVER_BOOTS.get(), "银靴子");
        add(ModArmors.TUNGSTEN_HELMET.get(), "钨头盔");
        add(ModArmors.TUNGSTEN_CHESTPLATE.get(), "钨胸甲");
        add(ModArmors.TUNGSTEN_LEGGINGS.get(), "钨护腿");
        add(ModArmors.TUNGSTEN_BOOTS.get(), "钨靴子");
        add(ModArmors.GOLDEN_HELMET.get(), "金头盔");
        add(ModArmors.GOLDEN_CHESTPLATE.get(), "金胸甲");
        add(ModArmors.GOLDEN_LEGGINGS.get(), "金护腿");
        add(ModArmors.GOLDEN_BOOTS.get(), "金靴子");
        add(ModArmors.PLATINUM_HELMET.get(), "铂金头盔");
        add(ModArmors.PLATINUM_CHESTPLATE.get(), "铂金胸甲");
        add(ModArmors.PLATINUM_LEGGINGS.get(), "铂金护腿");
        add(ModArmors.PLATINUM_BOOTS.get(), "铂金靴子");
        add(ModArmors.FOSSIL_HELMET.get(), "化石头盔");
        add(ModArmors.FOSSIL_CHESTPLATE.get(), "化石胸甲");
        add(ModArmors.FOSSIL_LEGGINGS.get(), "化石护腿");
        add(ModArmors.FOSSIL_BOOTS.get(), "化石靴子");
        add(ModArmors.NINJA_HELMET.get(), "忍者头盔");
        add(ModArmors.NINJA_CHESTPLATE.get(), "忍者胸甲");
        add(ModArmors.NINJA_LEGGINGS.get(), "忍者护腿");
        add(ModArmors.NINJA_BOOTS.get(), "忍者靴子");
        // 鱼
