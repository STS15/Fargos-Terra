...
public class PotionItems {
    ...
    public static final DeferredItem<AbstractPotionItem> GRAVITATION_POTION = POTIONS.register("gravitation_potion", () -> new EffectPotionItem(TCEffects.GRAVITATION, 3600));
