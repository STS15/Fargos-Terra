...
public class ModEnglishProvider extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        add("item.confluence.horseshoe_balloon.tooltip", "Increases jump height and negates fall setDamage");
        ...
        add("item.confluence.bundle_of_horseshoe_balloon.tooltip2", "Increases jump height and negates fall setDamage");
        add("item.confluence.water_walking_boots.tooltip", "Provides the ability to walk on water & honey");
        add("item.confluence.magma_skull.tooltip", "Immunity to fire blocks, melee attacks deal fire setDamage");
        ...
        add("item.confluence.panic_necklace.tooltip", "Increases movement speed after taking setDamage");
        add("item.confluence.paladins_shield.tooltip", "Absorbs 25% of setDamage done to players on your team when above 25% life");
        add("item.confluence.frozen_shield.tooltip", "Absorbs 25% of setDamage done to players on your team when above 25% life");
        add("item.confluence.frozen_shield.tooltip2", "Puts a shell around the owner when below 50% life that reduces setDamage by 25%");
        add("item.confluence.frozen_turtle_shell.tooltip", "Puts a shell around the owner when below 50% life that reduces setDamage by 25%");
        add("item.confluence.fire_gauntlet.tooltip", "Increases melee knockback and melee attacks inflict fire setDamage");
        add("item.confluence.cross_necklace.tooltip", "Increases TOTAL_LENGTH of invincibility after taking setDamage");
        ...
        add("item.confluence.worm_scarf.tooltip", "Reduces setDamage taken by 17%");
        ...
        add("item.confluence.royal_gel.tooltip", "Slimes cannot setDamage you");
        ...
        add("item.confluence.celestial_emblem.tooltip2", "15% increased magic setDamage");
        ...
        add("item.confluence.star_cloak.tooltip", "Causes stars to fall after taking setDamage");
