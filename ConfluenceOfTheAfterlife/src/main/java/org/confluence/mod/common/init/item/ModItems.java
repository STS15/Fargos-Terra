...
public final class ModItems {
    ...
    public static final Supplier<ManaStar> MANA_STAR = ITEMS.register("mana_star", ManaStar::new);
    public static final Supplier<LifeCrystal> LIFE_CRYSTAL = ITEMS.register("life_crystal", LifeCrystal::new);
    public static final Supplier<LifeFruit> LIFE_FRUIT = ITEMS.register("life_fruit", LifeFruit::new);
    ...
    public static final Supplier<HoneyBucketItem> HONEY_BUCKET = ITEMS.register("honey_bucket", () -> new HoneyBucketItem());
